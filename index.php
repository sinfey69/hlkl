...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	$goodslist = exchange_get_goods($children, $integral_min, $integral_max, $ext, 9999999, $page, $sort, $order);
	//var_dump($goodslist);
	$smarty->assign('cat_goods',    $goodslist); //获取分类下商品 Add by Jole
    ...
    //首页广告轮播
    $sql = "SELECT * FROM ecs_ad WHERE enabled=1 AND position_id=1";
    $adarr = $db->getAll($sql);
