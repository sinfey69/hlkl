...
$_LANG['16_draw_list'] = '积分抽奖管理';
$_LANG['15_exchange_goods_list'] = '积分商城商品列表';
$_LANG['exchange_goods_add'] = '添加新商品';
$_LANG['exchange_draw_add'] = '添加活动';
$_LANG['exchange_draw_prize_add'] = '添加奖品';
$_LANG['exchange_draw_edit'] = '编辑活动';
$_LANG['exchange_draw_prize_edit'] = '编辑活动奖品';
$_LANG['17_exchange_draw'] = '抽奖活动管理';
$_LANG['17_exchange_draw_list'] = '抽奖活动列表';
$_LANG['17_exchange_draw_prize_list'] = '活动奖品列表';
/* cls_image类的语言项 */
