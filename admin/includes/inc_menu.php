...
$modules['03_promotion']['16_draw_list']       		= 'draw.php?act=list';
$modules['03_promotion']['17_exchange_draw']   = 'exchange_draw.php?act=list';
...
$modules['06_stats']['export_order']                = 'export_order.php?act=list';
$modules['06_stats']['export_members']    			= 'export_members.php?act=list';
