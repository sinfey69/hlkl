...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('exchange_goods')."(goods_id, exchange_integral, is_exchange, is_hot,goods_price) ".
            "VALUES ('$_POST[goods_id]', '$_POST[exchange_integral]', '$_POST[is_exchange]', '$_POST[is_hot]', '$_POST[goods_price]')";
    $db->query($sql);
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    /* 取商品数据 */
    $sql = "SELECT eg.goods_id, eg.exchange_integral,eg.is_exchange, eg.is_hot,eg.goods_price, g.goods_name ".
...
if ($_REQUEST['act'] =='update')
{
    ...
    if ($exc->edit("exchange_integral='$_POST[exchange_integral]', is_exchange='$_POST[is_exchange]', is_hot='$_POST[is_hot]', goods_price='$_POST[goods_price]' ", $_POST['goods_id']))
    {
