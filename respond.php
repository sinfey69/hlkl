...
if($pay_code == 'alipay'){
	...
	$notify_time 	= isset($_REQUEST['notify_time']) ? strtotime($_REQUEST['notify_time']): '';
	
	$sql = "UPDATE ecs_order_info SET order_status=1,shipping_status=0,pay_status=2,pay_time=".$notify_time." WHERE order_sn='".$subject."'";
	$db->query($sql);
