...
header("Content-Type:text/html; charset=utf-8");
 ...
 //{
 //    echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>ECShop_mobile</title></head><body><p align='left'>对不起,{$_CFG['shop_name']}手机购物功能正在维护中......</p></body></html>";
 //    exit();
 //}
