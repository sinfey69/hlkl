...
?>
		...
		<div class="us_contentBox mod1 mod2">
        <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
    <h6><?php echo $this->_var['lang']['profile']; ?></h6>
     <form name="formEdit" action="user.php" method="post" onsubmit="return userEdit()">
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
				...
				<tr>
					...
					<td width="72%" align="left" bgcolor="#FFFFFF">
					<input name="email" type="text" value="<?php echo $this->_var['profile']['email']; ?>" size="25" class="InputBorder" /><span style="color:#FF0000"> *</span>
					</td>
				</tr>
...
?>
				...
				<tr>
					...
					<td width="72%" align="left" bgcolor="#FFFFFF">
					<input name="passwd_answer" type="text" size="25" class="InputBorder" maxlengt='20' value="<?php echo $this->_var['profile']['passwd_answer']; ?>"/><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
					</td>
				</tr>
				<?php else: ?>
				<tr>
					...
					<td width="72%" align="left" bgcolor="#FFFFFF">
					<input name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" class="InputBorder" value="<?php echo $this->_var['field']['content']; ?>"/><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
					</td>
				</tr>
				<?php endif; ?>
				<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
				<tr>
					<td colspan="2" align="center" bgcolor="#FFFFFF"><input name="act" type="hidden" value="act_edit_profile" />
						<input name="submit" type="submit" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" class="bnt_number4" />
					</td>
				</tr>
       </table>
    </form>
     ...
     <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr>
          ...
          <td width="76%" align="left" bgcolor="#FFFFFF"><input name="old_password" type="password" size="25"  class="InputBorder" /></td>
        </tr>
        <tr>
          <td width="28%" align="right" bgcolor="#FFFFFF"><?php echo $this->_var['lang']['new_password']; ?>：</td>
          <td align="left" bgcolor="#FFFFFF"><input name="new_password" type="password" size="25"  class="InputBorder" /></td>
        </tr>
        <tr>
          <td width="28%" align="right" bgcolor="#FFFFFF"><?php echo $this->_var['lang']['confirm_password']; ?>：</td>
          <td align="left" bgcolor="#FFFFFF"><input name="comfirm_password" type="password" size="25"  class="InputBorder" /></td>
        </tr>
        <tr>
          <td colspan="2" align="center" bgcolor="#FFFFFF">
					<input name="act" type="hidden" value="act_edit_password" />
            <input name="submit" type="submit" class="bnt_number4" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
          </td>
        </tr>
      </table>
    </form>
...
?>
    ...
    <div class="us_contentBox mod1 mod2">
    <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
    <h6><?php echo $this->_var['lang']['label_bonus']; ?></h6>
		 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr>
...
?>
    ...
    <div class="us_contentBox mod1 mod2">
    <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
    <h6><?php echo $this->_var['lang']['add_bonus']; ?></h6>
      <form name="addBouns" action="user.php" method="post" onsubmit="return addBonus()">
        <div style="padding: 15px;">
        <?php echo $this->_var['lang']['bonus_number']; ?>
          <input name="bonus_sn" type="text" size="30" class="InputBorder" />
          <input type="hidden" name="act" value="act_add_bonus" class="InputBorder" />
          <input type="submit" class="bnt_number4" value="<?php echo $this->_var['lang']['add_bonus']; ?>" />
        </div>
      </form>
		</div>	
    <?php endif; ?>
  ...
  <div class="us_contentBox mod1 mod2">
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
   <h6><?php echo $this->_var['lang']['label_order']; ?></h6>
	 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr align="center">
...
?>
			<tr>
				...
				<td align="center" bgcolor="#ffffff"><a href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>">查看</a> <font class="f6"><?php echo $this->_var['item']['handler']; ?></font></td>
			</tr>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	 </table>
  </div>
  ...
  <!--<div class="us_contentBox mod1 mod2">
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['merge_order']; ?></h6>
	<script type="text/javascript">
...
?>
  ...
  <form action="user.php" method="post" name="formOrder" onsubmit="return mergeOrder()">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              ...
              <input type="submit" name="Submit"  class="bnt_number4" style="border:none;"  value="<?php echo $this->_var['lang']['merge_order']; ?>" /></td>
            </tr>
            <tr>
              <td bgcolor="#ffffff">&nbsp;</td>
              <td colspan="4" align="left" bgcolor="#ffffff" class="f1"><?php echo $this->_var['lang']['merge_order_notice']; ?></td>
            </tr>
          </table>
        </form>
	</div>-->
 ...
 <div class="us_contentBox mod1 mod2">
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_track_packages']; ?></h6>
...
?>
 ...
 <?php endif; ?>
  ...
  <div class="us_contentBox mod1 mod2">
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['order_status']; ?></h6>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr>
          ...
          <?php if ($this->_var['order']['extension_code'] == "group_buy"): ?>
					<a href="./group_buy.php?act=view&id=<?php echo $this->_var['order']['extension_id']; ?>"><strong><?php echo $this->_var['lang']['order_is_group_buy']; ?></strong></a>
					<?php elseif ($this->_var['order']['extension_code'] == "exchange_goods"): ?>
					<a href="./exchange.php?act=view&id=<?php echo $this->_var['order']['extension_id']; ?>"><strong><?php echo $this->_var['lang']['order_is_exchange']; ?></strong></a>
					<?php endif; ?>  
					<a href="user.php?act=message_list&order_id=<?php echo $this->_var['order']['order_id']; ?>">[<u><?php echo $this->_var['lang']['business_message']; ?></u>]</a>
					</td>
        </tr>
        <tr>
...
?>
  ...
  <div class="us_contentBox mod1 mod2">
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6 class="clearfix"><span class="fl"><?php echo $this->_var['lang']['goods_list']; ?></span>
	 <span class="fr">
   <?php if ($this->_var['allow_to_cart']): ?>
    <a href="javascript:;" onclick="returnToCart(<?php echo $this->_var['order']['order_id']; ?>)" class="us_textDot"><?php echo $this->_var['lang']['return_to_cart']; ?></a>
   <?php endif; ?>
	 </span>
  </h6>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          ...
          <tr>
            <td bgcolor="#ffffff">
						...
						<?php elseif ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] == 'package_buy'): ?>
							<a href="javascript:void(0)" onclick="setSuitShow(<?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['goods_name']; ?><span style="color:#FF0000;">（礼包）</span></a>
...
?>
            ...
            <td align="center" bgcolor="#ffffff" class="price"><?php echo $this->_var['goods']['goods_number']; ?></td>
            <td align="right" bgcolor="#ffffff" class="price"><?php echo $this->_var['goods']['subtotal']; ?></td>
          </tr>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <tr>
            <td colspan="8" bgcolor="#ffffff" align="right">
            <?php echo $this->_var['lang']['shopping_money']; ?>
						<?php if ($this->_var['order']['extension_code'] == "group_buy"): ?>
						<font class="price"><?php echo $this->_var['lang']['gb_deposit']; ?></font>
						<?php endif; ?>: 
						<font class="price"><?php echo $this->_var['order']['formated_goods_amount']; ?></font>
            </td>
          </tr>
        </table>
  </div>
  ...
  <div class="us_contentBox mod1 mod2">
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['fee_total']; ?></h6>
   <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <td align="right" bgcolor="#ffffff">
                <?php echo $this->_var['lang']['goods_all_price']; ?><?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><?php echo $this->_var['lang']['gb_deposit']; ?><?php endif; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_goods_amount']; ?></font>
              <?php if ($this->_var['order']['discount'] > 0): ?>
              - <?php echo $this->_var['lang']['discount']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_discount']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['tax'] > 0): ?>
              + <?php echo $this->_var['lang']['tax']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_tax']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['shipping_fee'] > 0): ?>
              + <?php echo $this->_var['lang']['shipping_fee']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_shipping_fee']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['insure_fee'] > 0): ?>
              + <?php echo $this->_var['lang']['insure_fee']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_insure_fee']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['pay_fee'] > 0): ?>
              + <?php echo $this->_var['lang']['pay_fee']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_pay_fee']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['pack_fee'] > 0): ?>
              + <?php echo $this->_var['lang']['pack_fee']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_pack_fee']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['card_fee'] > 0): ?>
              + <?php echo $this->_var['lang']['card_fee']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_card_fee']; ?></font>
              <?php endif; ?>
							</td>
          </tr>
          <tr>
            <td align="right" bgcolor="#ffffff">
              ...
              - <?php echo $this->_var['lang']['order_money_paid']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_money_paid']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['surplus'] > 0): ?>
              - <?php echo $this->_var['lang']['use_surplus']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_surplus']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['integral_money'] > 0): ?>
              - <?php echo $this->_var['lang']['use_integral']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_integral_money']; ?></font>
              <?php endif; ?>
              <?php if ($this->_var['order']['bonus'] > 0): ?>
              - <?php echo $this->_var['lang']['use_bonus']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_bonus']; ?></font>
              <?php endif; ?>
							</td>
          </tr>
          <tr>
            <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['order_amount']; ?>: <font class="f1 f14b"><?php echo $this->_var['order']['formated_order_amount']; ?></font>
      ...
      <form action="user.php" method="post" name="formFee" id="formFee"><?php echo $this->_var['lang']['use_more_surplus']; ?>:
            <input name="surplus" type="text" size="8" value="0" class="InputBorder" /><?php echo $this->_var['max_surplus']; ?>
            <input type="submit" name="Submit" class="bnt_number2" value="<?php echo $this->_var['lang']['button_submit']; ?>" />
 ...
 <div class="us_contentBox mod1 mod2">
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['consignee_info']; ?></h6>
		...
		<form action="user.php" method="post" name="formAddress" id="formAddress">
		 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
				<tr>
					...
					<td width="35%" align="left" bgcolor="#ffffff"><input name="consignee" type="text"  class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['consignee']); ?>" size="25">
					</td>
					<td width="15%" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['email_address']; ?>： </td>
					<td width="35%" align="left" bgcolor="#ffffff"><input name="email" type="text"  class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['email']); ?>" size="25" />
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" bgcolor="#ffffff"><input name="address" type="text" class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['address']); ?> " size="25" /></td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['postalcode']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="zipcode" type="text"  class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['zipcode']); ?>" size="25" /></td>
				</tr>
				<?php endif; ?>
				<tr>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['phone']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="tel" type="text" class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['tel']); ?>" size="25" /></td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['backup_phone']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="mobile" type="text"  class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['mobile']); ?>" size="25" /></td>
				</tr>
				<?php if ($this->_var['order']['exist_real_goods']): ?>
				
				<tr>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['sign_building']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="sign_building" class="InputBorder" type="text" value="<?php echo htmlspecialchars($this->_var['order']['sign_building']); ?>" size="25" />
					</td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['deliver_goods_time']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="best_time" type="text" class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['best_time']); ?>" size="25" />
					</td>
				</tr>
				<?php endif; ?>
				<tr>
					<td colspan="4" align="center" bgcolor="#ffffff"><input type="hidden" name="act" value="save_order_address" />
						...
						<input type="submit" class="bnt_number8" value="<?php echo $this->_var['lang']['update_address']; ?>"  />
					</td>
				</tr>
			</table>
		</form>
 ...
 <div class="us_contentBox mod1 mod2">
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['payment']; ?></h6>
	<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
		<tr>
			<td bgcolor="#ffffff">
			<?php echo $this->_var['lang']['select_payment']; ?>: <?php echo $this->_var['order']['pay_name']; ?>。<?php echo $this->_var['lang']['order_amount']; ?>: <font class="f2"><?php echo $this->_var['order']['formated_order_amount']; ?></font><br />
...
?>
	...
	<input type="hidden" name="order_id" value="<?php echo $this->_var['order']['order_id']; ?>" />
	<input type="submit" name="Submit" class="bnt_number4" value="<?php echo $this->_var['lang']['button_submit']; ?>" />
	</form>
			</td>
		</tr>
		<?php endif; ?>
 ...
 <div class="us_contentBox mod1 mod2">
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['other_info']; ?></h6>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
...
?>
 ...
 <div class="us_contentBox mod1 mod2">
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['user_balance']; ?></h6>
	 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr>
				<td align="right" bgcolor="#ffffff">
				<a href="user.php?act=account_deposit" <?php if ($this->_var['action'] == 'account_deposit'): ?>class="f14b"<?php endif; ?>><?php echo $this->_var['lang']['surplus_type_0']; ?></a> | <a href="user.php?act=account_raply" <?php if ($this->_var['action'] == 'account_raply'): ?>class="f14b"<?php endif; ?>><?php echo $this->_var['lang']['surplus_type_1']; ?></a> | <a href="user.php?act=account_detail" <?php if ($this->_var['action'] == 'account_detail'): ?>class="f14b"<?php endif; ?>><?php echo $this->_var['lang']['add_surplus_log']; ?></a> | <a href="user.php?act=account_log" <?php if ($this->_var['action'] == 'account_log'): ?>class="f14b"<?php endif; ?>><?php echo $this->_var['lang']['view_application']; ?></a>
				</td>
			</tr>
   </table>
	<?php endif; ?>
	...
	<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
		<tr>
			...
			<td bgcolor="#ffffff" align="left"><input type="text" name="amount" value="<?php echo htmlspecialchars($this->_var['order']['amount']); ?>" class="InputBorder" size="30" />
			</td>
		</tr>
		<tr>
			<td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?>:</td>
			<td bgcolor="#ffffff" align="left"><textarea name="user_note" cols="55" rows="6" class="InputBorder"><?php echo htmlspecialchars($this->_var['order']['user_note']); ?></textarea></td>
		</tr>
		<tr>
			<td bgcolor="#ffffff" colspan="2" align="center">
			<input type="hidden" name="surplus_type" value="1" />
				<input type="hidden" name="act" value="act_account" />
				<input type="submit" name="submit"  class="bnt_number4" value="<?php echo $this->_var['lang']['submit_request']; ?>" />
				<input type="reset" name="reset" class="bnt_number4" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
			</td>
		</tr>
	</table>
	</form>
	...
	<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr>
				...
				<td align="left" bgcolor="#ffffff"><input type="text" name="amount"  class="InputBorder" value="<?php echo htmlspecialchars($this->_var['order']['amount']); ?>" size="30" /></td>
			</tr>
			<tr>
				<td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?>:</td>
				<td align="left" bgcolor="#ffffff"><textarea name="user_note" cols="55" rows="6"  class="InputBorder"><?php echo htmlspecialchars($this->_var['order']['user_note']); ?></textarea></td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr align="center">
...
?>
	...
	<input type="hidden" name="surplus_type" value="0" />
		...
		<input type="hidden" name="act" value="act_account" />
		<input type="submit" class="bnt_number4" name="submit" value="<?php echo $this->_var['lang']['submit_request']; ?>" />
		<input type="reset" class="bnt_number4" name="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
	</td>
</tr>
		</table>
	</form>
...
?>
		...
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<tr>
			<td colspan="4" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['current_surplus']; ?><font class="f2"><?php echo $this->_var['surplus_amount']; ?></font></td>
		</tr>
	</table>
	<?php echo $this->fetch('library/pages.lbi'); ?>
	<?php endif; ?>
...
?>
		...
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<tr>
			<td colspan="7" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['current_surplus']; ?><font class="f2"><?php echo $this->_var['surplus_amount']; ?></font></td>
		</tr>
	</table>
	<?php echo $this->fetch('library/pages.lbi'); ?>
  <?php endif; ?>
...
?>
				...
				<tr>
					...
					<td align="left" bgcolor="#ffffff"><input name="consignee" type="text" class="InputBorder" id="consignee_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?>" />
					<?php echo $this->_var['lang']['require_field']; ?> </td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['email_address']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="email" type="text" class="InputBorder" id="email_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['email']); ?>" />
					<?php echo $this->_var['lang']['require_field']; ?></td>
				</tr>
				<tr>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['detailed_address']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="address" type="text" class="InputBorder" id="address_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['address']); ?>" />
					<?php echo $this->_var['lang']['require_field']; ?></td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['postalcode']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="zipcode" type="text" class="InputBorder" id="zipcode_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?>" /></td>
				</tr>
				<tr>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['phone']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="tel" type="text" class="InputBorder" id="tel_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['tel']); ?>" />
					<?php echo $this->_var['lang']['require_field']; ?></td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['backup_phone']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="mobile" type="text" class="InputBorder" id="mobile_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?>" /></td>
				</tr>
				<tr>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['sign_building']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="sign_building" type="text" class="InputBorder" id="sign_building_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?>" /></td>
					<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['deliver_goods_time']; ?>：</td>
					<td align="left" bgcolor="#ffffff"><input name="best_time" type="text"  class="InputBorder" id="best_time_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['best_time']); ?>" /></td>
				</tr>
				<tr>
					<td align="right" bgcolor="#ffffff">&nbsp;</td>
					<td colspan="3" align="center" bgcolor="#ffffff">
					<?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['email']): ?>
						<input type="submit" name="submit" class="bnt_number4" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
						<input name="button" type="button" class="bnt_number2"  onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_address']; ?>'))location.href='user.php?act=drop_consignee&id=<?php echo $this->_var['consignee']['address_id']; ?>'" value="<?php echo $this->_var['lang']['drop']; ?>" />
						<?php else: ?>
						<input type="submit" name="submit" class="bnt_number6"  value="<?php echo $this->_var['lang']['add_address']; ?>"/>
						<?php endif; ?>
 ...
 <div class="us_contentBox mod1 mod2">
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
 <h6><?php echo $this->_var['lang']['transform_points']; ?></h6>
 ...
 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
		...
		<td bgcolor="#FFFFFF">
		<label for="pay_points"><?php echo $this->_var['lang']['exchange_points']['1']; ?>:</label><input type="text" size="15" id="pay_points" name="pay_points" value="<?php echo $this->_var['shop_points']['pay_points']; ?>" style="border:none; border-bottom:1px solid #DADADA;" readonly="readonly" /><br />
		<div class="blank"></div>
		<label for="rank_points"><?php echo $this->_var['lang']['exchange_points']['0']; ?>:</label><input type="text" size="15" id="rank_points" name="rank_points" value="<?php echo $this->_var['shop_points']['rank_points']; ?>" style="border:none; border-bottom:1px solid #DADADA;" readonly="readonly" />
		</td>
		</tr>
		...
		<tr>
			...
			<td bgcolor="#FFFFFF"><input size="15" name="amount" id="amount" value="0" onkeyup="calcredit();" type="text"  class="InputBorder"/>
					<select name="fromcredits" id="fromcredits" onchange="calcredit();"  class="InputBorder">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
			<input type="text" name="desamount" id="desamount" disabled="disabled" value="0" size="15"  class="InputBorder"/>
				<select name="tocredits" id="tocredits" onchange="calcredit();" class="InputBorder">
		...
		<input type="submit" name="transfrom" value="<?php echo $this->_var['lang']['transform']; ?>" class="bnt_number4" /></td></tr>
</table>
	</form>
 <script type="text/javascript">
...
?>
		<li>"<?php echo $this->_var['rule']['from']; ?>" <?php echo $this->_var['lang']['transform']; ?> "<?php echo $this->_var['rule']['to']; ?>" <?php echo $this->_var['lang']['rate_is']; ?> <?php echo $this->_var['rule']['rate']; ?></li>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	</ul>
	...
	<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" style="border-collapse:collapse;border:1px solid #DADADA;">
		...
		<tr>
			<td>
				<select name="rule_index" onchange="changeRule()" class="InputBorder">
...
?>
		...
		<td>
			<input type="text" name="num" value="0" onkeyup="calPoints()"  class="InputBorder"/>
		</td>
		...
		<tr>
			...
			<input type="submit" value="<?php echo $this->_var['lang']['transform']; ?>" class="bnt_number4" />
			</td>
		</tr>
	</table>
	</form>
