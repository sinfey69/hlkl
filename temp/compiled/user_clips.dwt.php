...
<div class="block1 clearfix">
 ...
 <?php if ($this->_var['action'] == 'default'): ?>
  <div class="us_contentBox default clearfix mod1 mod2">
  <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
	<font class="price"><?php echo $this->_var['info']['username']; ?></font> <?php echo $this->_var['lang']['welcome_to']; ?> <?php echo $this->_var['info']['shop_name']; ?>！<br /><br />
	<?php echo $this->_var['lang']['last_time']; ?>: <?php echo $this->_var['info']['last_time']; ?><br />
	<font class="f1"><?php echo $this->_var['rank_name']; ?> <?php echo $this->_var['next_rank_name']; ?></font><br />
	 <?php if ($this->_var['info']['is_validate'] == 0): ?>
	<?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
	 <?php endif; ?>
	 <div class="us_notice">
	 <img src="themes/helen_keller/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
	 </div>
	<div class="fl" style="width:350px;">
	<h5><?php echo $this->_var['lang']['your_account']; ?></h5>
	...
	<?php if (0): ?><?php echo $this->_var['lang']['your_integral']; ?>：<font class="price"><?php echo $this->_var['info']['integral']; ?></font><br /><?php endif; ?>
	</div>
	<div class="fr" style="width:350px;">
	<h5><?php echo $this->_var['lang']['your_notice']; ?></h5>
...
?>
	...
	<?php echo $this->_var['lang']['last_month_order']; ?><font class="price"><?php echo $this->_var['info']['order_count']; ?></font><?php echo $this->_var['lang']['order_unit']; ?><br />
...
<?php if ($this->_var['action'] == 'message_list'): ?>
 ...
 <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_message']; ?></h6>   
...
?>
	<div class="commentsTit">     
		<?php echo $this->_var['message']['msg_type']; ?>:&nbsp;&nbsp;<font class="f1"><?php echo $this->_var['message']['msg_title']; ?></font> (<?php echo $this->_var['message']['msg_time']; ?>)
		<a href="user.php?act=del_msg&amp;id=<?php echo $this->_var['key']; ?>&amp;order_id=<?php echo $this->_var['message']['order_id']; ?>" title="<?php echo $this->_var['lang']['drop']; ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_remove_msg']; ?>')) return false;" style="position:absolute; top:0px; right:10px;"><?php echo $this->_var['lang']['drop']; ?></a>
	</div>	
	<div class="commentsContent word">
	<?php echo $this->_var['message']['msg_content']; ?>
		 <?php if ($this->_var['message']['message_img']): ?>
		 <div class="tr">
		 <a href="data/feedbackimg/<?php echo $this->_var['message']['message_img']; ?>" target="_bank" class="us_textDot"><?php echo $this->_var['lang']['view_upload_file']; ?></a>
		 </div>
		 <?php endif; ?>
		 <?php if ($this->_var['message']['re_msg_content']): ?>
			 <div class="re_content">
			 <a href="mailto:<?php echo $this->_var['message']['re_user_email']; ?>"><font class="f1"><?php echo $this->_var['lang']['shopman_reply']; ?></font></a> (<?php echo $this->_var['message']['re_msg_time']; ?>)<br />
...
?>
	...
	<?php else: ?>
	 ...
	 <div id="pager">
		<?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?>
 ...
 <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onsubmit="return submitMsg()">
  <table width="100%" border="0" cellpadding="3">
		...
		<tr>
			...
			<td>
			<a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/helen_keller/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
			<input name="msg_type" type="hidden" value="5" />
			<input name="order_id" type="hidden" value="<?php echo $this->_var['order_info']['order_id']; ?>" class="InputBorder" />
			</td>
		</tr>
		<?php else: ?>
		<tr>
		...
		<tr>
			...
			<td><input type="hidden" name="act" value="act_add_message" />
				<input type="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="bnt_number2" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
...
<div class="us_contentBox  mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_comment']; ?></h6>
...
?>
   <div class="commentsTit">
	<?php if ($this->_var['comment']['comment_type'] == '0'): ?><?php echo $this->_var['lang']['goods_comment']; ?><?php else: ?><?php echo $this->_var['lang']['article_comment']; ?><?php endif; ?>: <font class="f1"><?php echo $this->_var['comment']['cmt_name']; ?></font>&nbsp;&nbsp;     (<?php echo $this->_var['comment']['formated_add_time']; ?>)
	<a href="user.php?act=del_cmt&amp;id=<?php echo $this->_var['comment']['comment_id']; ?>" title="<?php echo $this->_var['lang']['drop']; ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_remove_msg']; ?>')) return false;" style="position:absolute; top:0px; right:10px;"><?php echo $this->_var['lang']['drop']; ?></a>
	 </div>
	<div class="commentsContent word">
	<?php echo $this->_var['comment']['content']; ?>
		<?php if ($this->_var['comment']['reply_content']): ?>
		<div class="re_content">
		<b class="f1"><?php echo $this->_var['lang']['reply_comment']; ?>：</b><br />
...
<div class="us_contentBox  mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_tag']; ?></h6>
...
?>
 <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/helen_keller/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <?php else: ?>
...
<div class="us_contentBox mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_collection']; ?></h6>
...
?>
	<tr>
		...
		<td align="center" bgcolor="#ffffff">
			...
			<a href="javascript:if (confirm('<?php echo $this->_var['lang']['del_attention']; ?>')) location.href='user.php?act=del_attention&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>'" ><?php echo $this->_var['lang']['no_attention']; ?></a>
			<?php else: ?>
			<a href="javascript:if (confirm('<?php echo $this->_var['lang']['add_to_attention']; ?>')) location.href='user.php?act=add_to_attention&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>'" ><?php echo $this->_var['lang']['attention']; ?></a>
			<?php endif; ?>
			 <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" ><?php echo $this->_var['lang']['add_to_cart']; ?></a> <a href="javascript:if (confirm('<?php echo $this->_var['lang']['remove_collection_confirm']; ?>')) location.href='user.php?act=delete_collection&collection_id=<?php echo $this->_var['goods']['rec_id']; ?>'" class="f6"><?php echo $this->_var['lang']['drop']; ?></a>
		</td>
	</tr>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
...
<div class="us_contentBox mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_affiliate']; ?></h6>
 ...
 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
	...
	<tr>
		...
		<input type="button" name="gen_code" value="<?php echo $this->_var['lang']['generate']; ?>" onclick="genCode()" class="bnt_number4" />
		</td>
	</tr>
	<tr>
		<td colspan="2" align="center" bgcolor="#ffffff">
...
<div class="us_contentBox mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['label_booking']; ?></h6>
 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
	<tr align="center">
...
?>
	<tr>
		<td align="left" bgcolor="#ffffff"><a href="<?php echo $this->_var['item']['url']; ?>" target="_blank"><?php echo $this->_var['item']['goods_name']; ?></a></td>
		...
		<td align="center" bgcolor="#ffffff"><a href="javascript:if (confirm('<?php echo $this->_var['lang']['confirm_remove_account']; ?>')) location.href='user.php?act=act_del_booking&id=<?php echo $this->_var['item']['rec_id']; ?>'"><?php echo $this->_var['lang']['drop']; ?></a> </td>
	</tr>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
</div>
...
<div class="us_contentBox mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
  <h6><?php echo $this->_var['lang']['add']; ?><?php echo $this->_var['lang']['label_booking']; ?></h6>
 ...
 <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
	...
	<tr>
		...
		<td bgcolor="#ffffff"><input name="number" type="text" value="<?php echo $this->_var['info']['goods_number']; ?>" class="InputBorder" /></td>
	</tr>
	<tr>
		<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['describe']; ?>:</td>
		<td bgcolor="#ffffff"><textarea name="desc" cols="50" rows="5" wrap="virtual" class="InputBorder"><?php echo htmlspecialchars($this->_var['info']['goods_desc']); ?></textarea>
		</td>
	</tr>
	<tr>
		<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['contact_username']; ?>:</td>
		<td bgcolor="#ffffff"><input name="linkman" type="text" value="<?php echo htmlspecialchars($this->_var['info']['consignee']); ?>" size="25"  class="InputBorder"/>
		</td>
	</tr>
	<tr>
		<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['email_address']; ?>:</td>
		<td bgcolor="#ffffff"><input name="email" type="text" value="<?php echo htmlspecialchars($this->_var['info']['email']); ?>" size="25" class="InputBorder" /></td>
	</tr>
	<tr>
		<td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['contact_phone']; ?>:</td>
		<td bgcolor="#ffffff"><input name="tel" type="text" value="<?php echo htmlspecialchars($this->_var['info']['tel']); ?>" size="25" class="InputBorder" /></td>
	</tr>
	<tr>
		...
		<td bgcolor="#ffffff">
		  <input name="act" type="hidden" value="act_add_booking" />
			...
			<input type="submit" name="submit" class="bnt_number6" value="<?php echo $this->_var['lang']['submit_booking_goods']; ?>" />
...
<?php if ($this->_var['affiliate']['on'] == 1): ?>
  <?php if ($this->_var['action'] == 'affiliate'): ?>
   <?php if (! $this->_var['goodsid'] || $this->_var['goodsid'] == 0): ?>
		<div class="us_contentBox mod1 mod2">
        <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
		<h6><?php echo $this->_var['lang']['affiliate_detail']; ?></h6>
    ...
    <div class="us_contentBox mod1 mod2">
    <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
    <h6><a name="myrecommend"><?php echo $this->_var['lang']['affiliate_member']; ?></a></h6>
		<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr align="center">
...
<div class="us_contentBox mod1 mod2">
<span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
<h6><?php echo $this->_var['lang']['affiliate_code']; ?></h6>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
<tr>
