...
<h2><span class="l"></span><span class="r"></span><?php echo $this->_var['lang']['user_comment']; ?></h2>
</div>
...
?>
 <div class="commentsTit" style=" border: 1px solid red" >
  <?php if ($this->_var['comment']['username']): ?>
	...
	<?php endif; ?>
  给出 <img src="themes/helen_keller/images/stars<?php echo $this->_var['comment']['rank']; ?>.gif" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" /> 评分
...
<div class="Goodpromotion blank"  style=" border: 1px solid #ccc; position: relative; bottom: 6px">
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
       <table border="0" cellspacing="5" cellpadding="0">
        ...
        <tr style=" padding-top: 2px;">
          ...
          <td>
          <input name="comment_rank" type="radio" value="1" id="comment_rank1" /> <img src="themes/helen_keller/images/stars1.gif" />
          <input name="comment_rank" type="radio" value="2" id="comment_rank2" /> <img src="themes/helen_keller/images/stars2.gif" />
          <input name="comment_rank" type="radio" value="3" id="comment_rank3" /> <img src="themes/helen_keller/images/stars3.gif" />
          <input name="comment_rank" type="radio" value="4" id="comment_rank4" /> <img src="themes/helen_keller/images/stars4.gif" />
          <input name="comment_rank" type="radio" value="5" checked="checked" id="comment_rank5" /> <img src="themes/helen_keller/images/stars5.gif" />
          </td>
        </tr>
        <tr style=" padding-top: 2px;">
          <td align="right" valign="top"><?php echo $this->_var['lang']['comment_content']; ?>：</td>
          <td>
          <textarea name="content" class="InputBorder" cols="75" style=" width: 880px; height: 150px;"></textarea>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_39040200_1425437595');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_39040200_1425437595']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_39040200_1425437595']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
