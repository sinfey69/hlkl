<div id="footer" class="clearfix">
 <div class="block tc" style="margin-bottom:16px; text-align: center; line-height: 20px;">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_24686100_1419295254');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_24686100_1419295254']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_24686100_1419295254']['url']; ?>" <?php if ($this->_var['nav_0_24686100_1419295254']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_24686100_1419295254']['name']; ?></a> 
 ...
 <div style="width:750px;position:relative;top:-10px;font-size:12px;color:#6E4C0F;">
   ...
   <div class="fr" style="position:relative;top:2px;line-height:20px;">
    ...
    <?php echo $this->_var['lang']['icp_number']; ?>：<a href="http://www.miibeian.gov.cn/" target="_blank" style="font-size:12px;color:#6E4C0F;"><?php echo $this->_var['icp_number']; ?></a><br />
    <?php endif; ?>
    <?php if ($this->_var['shop_address']): ?>
        地址：<?php echo $this->_var['shop_address']; ?>
    <?php endif; ?>
...
?>
      <?php if ($this->_var['im']): ?>
      <a href="http://edit.yahoo.com/config/send_webmesg?.target=<?php echo $this->_var['im']; ?>n&.src=pg" target="_blank"><img src="themes/helen_keller/images/yahoo.gif" width="18" height="17" border="0" alt="Yahoo Messenger" /> <?php echo $this->_var['im']; ?></a>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
      <?php if ($this->_var['im']): ?>
      <img src="themes/helen_keller/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=<?php echo $this->_var['im']; ?>"><?php echo $this->_var['im']; ?></a>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
