...
<?php endif; ?>
<span class="action-span1"><a href="index.php?act=main">helenkeller 管理中心</a> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> - <?php echo $this->_var['ur_here']; ?> <?php endif; ?></span>
