...
<div class="form-div">
  <form action="javascript:searchMobile()" name="searchForm">
	...
	抽奖活动<select name="did">
		...
		<?php $_from = $this->_var['draw_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'list_0_66526300_1419309162');if (count($_from)):
    foreach ($_from AS $this->_var['list_0_66526300_1419309162']):
?>
		<option value="<?php echo $this->_var['list_0_66526300_1419309162']['did']; ?>"><?php echo $this->_var['list_0_66526300_1419309162']['draw_title']; ?></option>
...
?>
  <tr>
    ...
    <td style="text-align:center;"><?php echo $this->_var['draw']['name']; ?></td>
    <td style="text-align:center;"><?php echo $this->_var['draw']['consignee']; ?></td>
    <td style="text-align:center;"><?php echo $this->_var['draw']['province']; ?>&nbsp;&nbsp;<?php echo $this->_var['draw']['city']; ?>&nbsp;&nbsp;<?php echo $this->_var['draw']['district']; ?>&nbsp;&nbsp;<?php echo $this->_var['draw']['address']; ?></td>
    <td style="text-align:center;"><?php if ($this->_var['draw']['mobile2'] != ''): ?><?php echo $this->_var['draw']['mobile2']; ?><?php else: ?><?php echo $this->_var['draw']['tel']; ?><?php endif; ?></td>
