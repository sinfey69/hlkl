...
?>
		...
		<?php if ($this->_var['order']['is_deduct'] == 0 && $this->_var['order']['pay_status'] == 2): ?><b><font size="2" color="Red"><?php echo $this->_var['lang']['label_integral_deduct']; ?><?php echo $this->_var['lang']['ids'][$this->_var['order']['is_deduct']]; ?>。原因：ccs系统通信失败。</font></b><?php endif; ?>
		</td>
