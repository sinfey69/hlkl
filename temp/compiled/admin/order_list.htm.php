...
?>
  <tr>
    ...
    <td align="center"><?php echo htmlspecialchars($this->_var['order']['time_quantum']); ?></td>
	
	<td align="left" valign="top" nowrap="nowrap"><?php echo $this->_var['order']['mobile_province']; ?>&nbsp;&nbsp;<?php echo $this->_var['order']['mobile_supplier']; ?></td>
    <td align="left" valign="top"><a href="mailto:<?php echo $this->_var['order']['email']; ?>"> <?php echo htmlspecialchars($this->_var['order']['consignee']); ?></a><?php if ($this->_var['order']['tel']): ?> [TEL: <?php echo htmlspecialchars($this->_var['order']['tel']); ?>]<?php endif; ?> 
	<br /><?php echo htmlspecialchars($this->_var['order']['province']); ?><?php echo htmlspecialchars($this->_var['order']['city']); ?><?php echo htmlspecialchars($this->_var['order']['district']); ?><?php echo htmlspecialchars($this->_var['order']['address']); ?></td>
   	<td align="left" valign="top" nowrap="nowrap"><?php echo $this->_var['order']['pay_name']; ?></td>
