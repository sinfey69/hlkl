...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><a href="javascript:listTable.sort('last_login'); ">最近一次登录时间</a></th>
	<th>总积分</th>
	<th>剩余积分</th>
...
?>
  <tr>
    ...
    <td align="center"><?php echo htmlspecialchars($this->_var['user']['shop_name']); ?></td>
    <td align="center"><?php echo htmlspecialchars($this->_var['user']['mobile_province']); ?></td>
    <td align="center"><?php echo htmlspecialchars($this->_var['user']['mobile_supplier']); ?></td>
	...
	<td align="center"><?php echo $this->_var['user']['visit_count']; ?></td>
    ...
    <td align="center"><?php echo $this->_var['user']['last_login']; ?></td>
    <td align="center"><?php echo $this->_var['user']['winning']; ?></td>
    <td align="center"><?php echo $this->_var['user']['canuse']; ?></td>
    <td align="center">
