      ...
      <div class="boxCenterList">
       <?php if ($this->_var['notes']): ?>
        <table width="100%" cellpadding="4">
         <tr style="background-color:#F3F3F3; height:24px; line-height:24px; text-align:center; color:#434343; font-weight:bold;">
          <td width="25%"><?php echo $this->_var['lang']['username']; ?></td>
	  <td width="30%">商品名称</td>
	  <td width="10%"><?php echo $this->_var['lang']['number']; ?></td>
	  <td width="15%"><?php echo $this->_var['lang']['bought_time']; ?></td>
	  <td width="20%"><?php echo $this->_var['lang']['order_status']; ?></td>
	 </tr>
...
?>
         <tr align="center">
	     <td>
	        <?php if ($this->_var['note']['user_name']): ?><?php echo htmlspecialchars($this->_var['note']['user_name']); ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?>
	     </td>
	     <td><?php echo $this->_var['note']['goods_name']; ?></td>
       ...
       <div id="buy_pagebar" class="f_r" style="margin-top:10px">
        ...
        <div id="buy_pager" class="pagebar">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_37609500_1425437595');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_37609500_1425437595']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_37609500_1425437595']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="buy_pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_37657500_1425437595');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_37657500_1425437595']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_37657500_1425437595']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_37716200_1425437595');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_37716200_1425437595']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_37716200_1425437595']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
